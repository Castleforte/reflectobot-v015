...
import { playExclusiveAudio, stopCurrentAudio, playHoverAudio, playButtonClickAudio } from './utils/audioManager';
...
function App() {
  ...
  const [voicesEnabled, setVoicesEnabled] = useState<boolean>(progress.voicesEnabled);
  const [soundsEnabled, setSoundsEnabled] = useState<boolean>(progress.soundsEnabled);
      ...
      <div className="app-wrapper">
        ...
        {currentScreen === 'settings' ? (
          <SettingsSection 
            ...
            setVoicesEnabled={setVoicesEnabled}
