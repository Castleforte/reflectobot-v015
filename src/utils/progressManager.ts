...
export const getInitialProgress = (): ReflectoBotProgress => {
  ...
  return {
    ...
    // Sound settings - separate controls
    voicesEnabled: true,
    soundsEnabled: true
  };
};
  ...
  try {
    ...
    if (saved) {
      ...
      const progress = { 
        ...
        // Handle migration from old soundEnabled to new separate controls
        voicesEnabled: parsed.voicesEnabled ?? parsed.soundEnabled ?? true,
        soundsEnabled: parsed.soundsEnabled ?? parsed.soundEnabled ?? true
      };
      ...
      console.log('📖 Progress loaded from localStorage:', {
        ...
        voicesEnabled: progress.voicesEnabled,
        soundsEnabled: progress.soundsEnabled
      });
...
export const updateProgress = (updates: Partial<ReflectoBotProgress>): ReflectoBotProgress => {
  ...
  if (updates.colorsUsedInDrawing !== undefined || updates.hasLongMessageSent !== undefined || updates.selectedRobotId !== undefined || updates.voicesEnabled !== undefined || updates.soundsEnabled !== undefined) {
    console.log('🔄 Updating badge-critical progress:', {
      before: {
        ...
        voicesEnabled: current.voicesEnabled,
      ...
      updates: {
        ...
        voicesEnabled: updates.voicesEnabled,
        soundsEnabled: updates.soundsEnabled
      },
      after: {
        ...
        voicesEnabled: updated.voicesEnabled,
